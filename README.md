...
|---|---|---|---|---|---|---|
| **Manthan Dubey** | Developer | 25% | **40%** | 10% | 25% | MVP Scoping, Rapid Prototyping, User Validation, Product Practicality |
| **Ayush** | Startup Founder | **35%** | 15% | 10% | **40%** | Startup Building, Product Strategy, Growth Hack, Product-Market Fit |
...
│   ├── judges.ts                     # Manthan, Ayush, Nishika, Sejal, Jitu data
